...
def get_dataset_config(dataset: str, first_stage_stride: bool = False) -> DatasetConfig:
    """Get the appropriate configuration for a dataset.
    ...
    # ImageNet or other large-image datasets
...
class QuantMobileNetV1(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            weight_bit_width: Bit width for weight quantization.
            act_bit_width: Bit width for activation quantization.
            dataset: Dataset name for architecture configuration
        ...
        config = get_dataset_config(dataset, first_stage_stride)
