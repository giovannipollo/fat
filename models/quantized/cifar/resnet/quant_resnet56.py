"""Quantized ResNet-56 model for CIFAR datasets."""

from .base import QuantResNetCIFAR


class QuantResNet56(QuantResNetCIFAR):
    """Quantized ResNet-56 for CIFAR-10/100 and small image datasets.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize Quantized ResNet-56.
